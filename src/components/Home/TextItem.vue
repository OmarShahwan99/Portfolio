    ...
    data() {
        return {
            ...
            socialIcons: [
                ...
                { icon: 'fa-linkedin-in', link: 'www.linkedin.com/in/omar-shahwan-4b615624a?lipi=urn%3Ali%3Apage%3Ad_flagship3_profile_view_base_contact_details%3BLk7RH6KuQqmnn2NP21nTEg%3D%3D' }
            ],
        }
    },
    methods: {
